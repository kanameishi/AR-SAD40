...
- `_ref/TITO-kb/research/g10.aci.concrete.section.verification.es.md`.

La vista oficial de ACI CODE-318.2-25 y su huella digital están registradas en
`_ref/TITO-kb/MANIFEST.md`. El informe CIRSOC anterior se conserva únicamente como
antecedente histórico no gobernante en
`_ref/TITO-kb/research/g10.shotcrete.section.verification.es.md`.
...
- `_chapters/methodology.shotcrete.scope.es.md`;
- `_chapters/methodology.shotcrete.section.es.md`; y
- `_chapters/methodology.shotcrete.controls.es.md`.
