...
|---|---|---|---|
| chapa corrugada | `g10.corrugated.steel.verification.es.md` | `g10.corrugated.steel.verification.audit.es.md` | evidencia `PASS`; implementación bloqueada por datos y decisiones `UNKNOWN` |
