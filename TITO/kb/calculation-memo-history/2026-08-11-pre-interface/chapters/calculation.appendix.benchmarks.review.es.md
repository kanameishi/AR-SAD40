...
Este apéndice distingue datos publicados transcritos (DP), resultados
publicados reproducidos (RP), resultados derivados en este estudio (DE) y
controles matemáticos internos (CI). La coincidencia numérica comprueba
transcripción, unidades y evaluación de fórmulas dentro de cada caso; no
constituye por sí sola una validación de las acciones del relleno del
...
| Magnitud | Publicado | Calculado | Unidad | Clase |
|---|---:|---:|---|---|
| presión vertical permanente en clave | 3600 | 3600 | lb/ft² | DP + RP |
| fuerza normal sin factores | — | 5400 | lb/ft | DE |
| fuerza normal factorizada | 10530 | 10530 | lb/ft | DP + RP |
| demanda con modificador del ejemplo | 11583 | 11583 | lb/ft | DP + RP |
...
la fuente, la fuerza normal positiva es compresiva.

| Secuencia | Interfaz | $T/(PR)$ publicado | Calculado | $M/(PR^2)$ publicado | Calculado |
|---|---|---:|---:|---:|---:|
...
Los ejemplos de Núñez corresponden a túneles excavados y utilizan compresión
positiva [@Nunez2000, pp. 14--15]. La unidad original se conserva; para una
conversión posterior se adopta $1\ \mathrm{tf}=9.80665$ kN.
...
## B.6 Núñez, Sfriso y Laiún (2014): caso 3 {.unnumbered}

La publicación de 2014 compara resultados analíticos y bidimensionales para
siete túneles de Buenos Aires [@NunezSfrisoLaiun2014, tabla 3, p. 7]. Para el
caso 3 se transcriben:

| Resultante | Formulación analítica | Análisis bidimensional | Unidad |
|---|---:|---:|---|
| $N_C$ | 720 | 500 | kN/m |
| $M_C$ | 10.2 | 10.0 | kN·m/m |
| $M_A$ | 13.8 | 65.0 | kN·m/m |

: Valores publicados para el caso 3 de Núñez, Sfriso y Laiún (2014). {#tbl-calculation-nunez-2014-contrast}

La información publicada disponible no contiene todos los datos necesarios
para una reproducción independiente completa. Los valores se clasifican como
datos publicados transcritos y no como comprobación del procedimiento adoptado
en esta memoria.
...
dominio. Schwartz--Einstein y Núñez permiten auditar formulaciones alternativas
de interacción y sus convenciones. Ninguno sustituye la caracterización del
relleno compactado ni determina por sí solo la transferencia tangencial del
revestimiento existente.

CANDE se mantiene como referencia del estado de la práctica para análisis
acoplado de conductos enterrados [@KatonaEtAl1976CANDE;
@CANDE2025Formulations]. Su incorporación cuantitativa exige seleccionar un
caso común, documentar entradas y convenciones y reproducir sus resultados; esa
comparación no está cerrada en la evidencia disponible.
