...
| 3 | tensiones verticales, laterales, agua y parámetros de interfaz | transformar el estado tensional y aplicar el límite de Coulomb | $P_r(\theta)$ y $P_t(\theta)$ | capacidad tangencial, equilibrio global y signos |
