...
respuesta de la sección transversal y las comprobaciones estructurales de la
chapa de acero corrugada y de secciones de hormigón proyectado simple o
armado. El estudio de hormigón armado comprende mallas simétricas y una
sección compuesta explícita formada por la chapa existente y una malla
interior. La memoria de cálculo aplica ese procedimiento a un escenario
determinado.
...
Cada alternativa autónoma utiliza sus propias rigideces circunferenciales y
no transfiere resultantes entre la chapa y el hormigón. La sección compuesta
constituye un caso distinto: combina ambos materiales, determina su centroide
y sus rigideces y recalcula la demanda con esas propiedades. El problema es
plano, sin variación longitudinal de las cargas, y las magnitudes se expresan
por unidad de longitud del eje.
...
del cálculo. Las mallas simétricas de un mismo espesor comparten la demanda
calculada con la rigidez fisurada adoptada. La sección compuesta recalcula la
demanda con sus propias rigideces. El usuario puede modificar los parámetros y
reevaluar el caso; la metodología no selecciona una cuantía óptima ni adopta
una malla final.
...
Para el hormigón proyectado, ACI CODE-318-25 proporciona las comprobaciones
seccionales de flexocompresión y corte. ACI 318.2-14 se conserva como base
bibliográfica explícita del control separado de armadura mínima y distribución
entre caras; ese control no selecciona una malla ni reemplaza el dominio
$P$--$M$. La fisuración, el servicio, la durabilidad, las juntas, los anclajes,
la transferencia con la chapa y la estabilidad global requieren sus propias
comprobaciones.

La metodología vigente es determinística. Las condiciones de interfaz, las
propiedades y las alternativas se evalúan como escenarios separados, sin
asignarles probabilidades ni combinarlos en una distribución de respuesta.
