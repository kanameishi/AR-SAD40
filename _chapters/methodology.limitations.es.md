...
nominales alternativos claramente identificados y separados de las demás
...
8. **Identificación de estados gobernantes.** Cada extremo se registra junto
   con su magnitud, signo, posición angular y etapa constructiva.
9. **Contraste con referencias.** La rama escalar de chapa se compara con la
...
$K_N$ y $K_M$ de una viga curva por unidad de longitud axial. Esta
idealización entrega $N_\theta$, $M_\theta$ y $Q_\theta$. La rama resistente
de la chapa utiliza luego las propiedades seccionales y las acciones
concurrentes para comprobar pared, pandeo, costura, flexibilidad y tapada
mínima.

La aplicación requiere confirmar la geometría seccional, la representatividad
de los parámetros geotécnicos adoptados, el estado hidráulico y la secuencia de
compactación. Esos antecedentes actualizan las entradas del escenario y no se
sustituyen por un coeficiente de reducción con la profundidad.
