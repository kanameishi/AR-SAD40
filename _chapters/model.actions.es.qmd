...
La aplicación calcula $K_0$ a partir de sus variables primitivas. Para la rama
de descarga de Mayne--Kulhawy se emplea [@MayneKulhawy1982]

$$
K_0=(1-\sin\phi')\,\mathrm{OCR}^{\sin\phi'}.
$$ {#eq-calculation-k0-unloading}

Con las entradas vigentes,
$\phi'=`r formatCalculationGeneral(Calculation$stress$frictionAngleDeg)`^\circ$,
$\mathrm{OCR}=`r formatCalculationGeneral(Calculation$stress$ocr)`$ y la
expresión produce
