...
Estas verificaciones comprueban la compatibilidad, el equilibrio y el control
separado de cuantía mínima; no adoptan una malla. Las demandas de cáscara, el
corte, la acción longitudinal, la estabilidad y el detallado se evalúan con el
articulado aplicable de ACI CODE-318.2-25.
